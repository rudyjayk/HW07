...
public:
	...
	void show_stats()
	{
		...
		std::cout << "Average wait time for all planes in arrival queue: " << landing_queue->get_total_wait() / landing_queue->get_num_served() << std::endl;
		...
		std::cout << "Average wait time for all planes in  departure queue: " << departure_queue->get_total_wait() / departure_queue->get_num_served() << std::endl;
